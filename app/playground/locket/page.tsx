        ...
        <div className="container-inner section-padding">
          <FadeIn>
            <div className="bg-surface rounded-3xl p-10 md:p-14 border border-border shadow-card max-w-3xl mx-auto text-center">
              ...
              <a
                href="https://www.figma.com/proto/im8z061u2cDELglU4eaokM/Locket-App-Documentation---Sweta-Devnani--Perpay-Assignmnet---Copy-?node-id=2207-97&page-id=2127%3A1994&scaling=scale-down&content-scaling=fixed&t=Ou5myPZEkyRIGzz4-1"
                target="_blank"
