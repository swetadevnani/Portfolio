          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <FadeIn delay={0.05}>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a href="https://drive.google.com/file/d/1O_6MPlcc__YNSNWAqNo28qwqGbDPAVjX/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn-secondary inline-flex items-center gap-2">
